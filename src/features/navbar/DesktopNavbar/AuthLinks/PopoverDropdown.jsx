...
export default function PopoverDropdown({ myUser, myProfile, logoutHandler }) {
  return (
    <div className="">
          ...
          <>
            <Popover.Button
              className={`
                ...
                bg-orange-700 group inline-flex items-center rounded-md px-3 py-2 text-base font-medium text-white hover:text-opacity-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75`}
            >
              <Image
                className="inline-flex h-8  w-8 rounded-full object-cover text-gray-600 dark:text-white"
                src={myProfile && myProfile && myProfile.picture}
                alt=""
              />
            </Popover.Button>
            <Transition
