...
import NavSearchBar from '../DesktopNavbar/NavSearchBar';

import { BottomPanel, TopPanel, DialogContainer } from '../CartSlider/CartSliderElements';
...
export default function MobileNavbar({ isAuthenticated, myUser, myProfile }) {
