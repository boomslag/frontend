...
import CartItem from '@/features/navbar/CartItem';
import CourseCartItem from '@/features/navbar/CourseCartItem';
  ...
  return (
    <div className="dark:bg-dark-bg">
      ...
      <div className=" mx-auto max-w-2xl px-4 py-12 sm:px-6 lg:max-w-7xl lg:px-8">
        <p className="dark:border-dark-border border-b border-gray-400 text-3xl font-bold tracking-tight dark:text-dark-txt text-gray-900 sm:text-4xl">
          Shopping Cart
        </p>
