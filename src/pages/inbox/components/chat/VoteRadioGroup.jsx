...
export default function VoteRadioGroup({ poll, onVote }) {
  ...
  return (
    <div className="mr-2">
      <label className="text-base font-semibold text-gray-900">{poll.question}</label>
      <p className="text-sm text-gray-500">Total votes: {poll.total_votes_count}</p>
      ...
      <form onSubmit={handleSubmit} className="mt-4">
        <div className="space-y-4">
          ...
          <button
            type="submit"
            disabled={selectedOption === null || poll.voted}
