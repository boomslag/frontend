...
export default function Sidebar({ course, courseUUID }) {
  ...
  const plan = [
    // { name: 'Dashboard', href: '/instructor/dashboard', icon: HomeIcon, current: router.pathname === "/instructor/dashboard" ? true:false },
    {
      ...
      current: window.location.pathname === `/sell/courses/manage/goals/${courseUUID}`,
      ready:
        whoIsFor &&
        whoIsFor.length !== 0 &&
        requisites &&
...

    {
      ...
      current: window.location.pathname === `/sell/courses/manage/course_structure/${courseUUID}`,
    ...
    },
    {
      ...
      current: window.location.pathname === `/sell/courses/manage/setup/${courseUUID}`,
  ...
  const create = [
    // { name: 'Dashboard', href: '/instructor/dashboard', icon: HomeIcon, current: router.pathname === "/instructor/dashboard" ? true:false },
    {
      ...
      icon: AcademicCapIcon,
      current: window.location.pathname === `/sell/courses/manage/film/${courseUUID}`,
    ...
    },
    {
      ...
      icon: ChatBubbleLeftIcon,
      current: window.location.pathname === `/sell/courses/manage/curriculum/${courseUUID}`,
      ready: curriculum,
    },
    // {
    //     id: 3,
    ...
    //     icon: ShoppingCartIcon, current: window.location.pathname === `/sell/courses/manage/captions/${course_uuid}` ? true:false,
    //     ready: captions
    // },
    {
      id: 4,
      ...
      icon: ShoppingCartIcon,
      current: window.location.pathname === `/sell/courses/manage/accessibility/${courseUUID}`,
      ready: accessibility,
    },
  ];
  ...
  const publish = [
    // { name: 'Dashboard', href: '/instructor/dashboard', icon: HomeIcon, current: router.pathname === "/instructor/dashboard" ? true:false },
    {
      ...
      icon: AcademicCapIcon,
      current: window.location.pathname === `/sell/courses/manage/basics/${courseUUID}`,
      ready: landingPage,
    },
    {
      id: 2,
      ...
      icon: ChatBubbleLeftIcon,
      current: window.location.pathname === `/sell/courses/manage/pricing/${courseUUID}`,
      ready: pricing,
    },
    {
      id: 3,
      ...
      icon: ShoppingCartIcon,
      current: window.location.pathname === `/sell/courses/manage/promotions/${courseUUID}`,
      ready: promotions,
    },
    {
      id: 4,
      ...
      icon: ShoppingCartIcon,
      current: window.location.pathname === `/sell/courses/manage/messages/${courseUUID}`,
      ready: allowMessages,
    },
  ];
