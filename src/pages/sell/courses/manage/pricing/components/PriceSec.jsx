    ...
    <div>
      ...
      <div className="relative mt-1 ">
        <input
          ...
          className="ring-none w-full border dark:border-dark-border dark:bg-dark-bg dark:text-dark-txt-secondary border-gray-700 py-3 pl-14 outline-none focus:border-gray-500 focus:outline-transparent focus:ring-transparent"
          placeholder="99.90"
