      ...
      <div className="block bg-white dark:bg-dark-bg dark:border-dark-second dark:hover:bg-dark-third my-0.5 shadow-neubrutalism-md border-2 dark:shadow-none  border-gray-900 hover:bg-gray-50">
        <div className="px-4 py-4 sm:px-6">
          <div className="flex items-center justify-between">
            <Link
              href={`/sell/products/orders/${item.id}`}
          ...
          <div className="mt-2 sm:flex sm:justify-between">
            <div className="sm:flex">
              ...
              <p className="mt-2 flex items-center text-sm text-gray-500 sm:mt-0 sm:ml-6">
                ...
                {item.delivery_address ? (
                  <>
                    {item.delivery_address.address_line_1} | {item.delivery_address.address_line_2}
                  </>
                ) : (
                  <>
            ...
            <div className="mt-2 flex items-center text-sm text-gray-500 sm:mt-0">
              <CalendarIcon
                ...
                aria-hidden="true"
              />
              <p>{moment(item.date_added).format('MMMM Do YYYY')}</p>
            </div>
          </div>
        </div>
      </div>
