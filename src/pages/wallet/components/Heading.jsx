...
const web3 = new Web3(process.env.NEXT_PUBLIC_APP_RPC_PROVIDER);
const polygonWeb3 = new Web3(process.env.NEXT_PUBLIC_APP_POLYGON_RPC_PROVIDER);
...
export default function Heading({ fetchTokens, currentPage }) {
  ...
  const onSubmit = async (e) => {
    e.preventDefault();
    setLoading(true);
    await AddTokenToList(address, name, symbol, decimals, network);
